...
def busqueda_curso(request):
    ...
    mi_formulary: BusquedaCursoForm = BusquedaCursoForm(request.GET)
    if mi_formulary.is_valid():
        data = mi_formulary.cleaned_data
        cursos_filtrados = Curso.objects.filter(nombre__icontains=data['nombre'])
        context = {
